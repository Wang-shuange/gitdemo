...
//RGB2
#define RGB1_GPIO_PORT    	GPIOC	              /* GPIO端口 */
#define RGB1_GPIO_CLK 	    RCC_APB2Periph_GPIOC		/* GPIO端口时钟 */
#define RGB1_GPIO_PIN			  GPIO_Pin_7			        

#define RGB2_GPIO_PORT    	GPIOC			              /* GPIO端口 */
#define RGB2_GPIO_CLK 	    RCC_APB2Periph_GPIOC		/* GPIO端口时钟 */
#define RGB2_GPIO_PIN	    	GPIO_Pin_8		        

#define RGB3_GPIO_CLK       RCC_APB2Periph_GPIOC
#define RGB3_GPIO_PORT      GPIOC		   
#define RGB3_GPIO_PIN		    GPIO_Pin_9

//RGB3
#define RGB31_GPIO_PORT    	GPIOD	              /* GPIO端口 */
#define RGB31_GPIO_CLK 	    RCC_APB2Periph_GPIOD		/* GPIO端口时钟 */
#define RGB31_GPIO_PIN			GPIO_Pin_13			        

#define RGB32_GPIO_PORT    	GPIOD			              /* GPIO端口 */
#define RGB32_GPIO_CLK 	    RCC_APB2Periph_GPIOD		/* GPIO端口时钟 */
#define RGB32_GPIO_PIN	    GPIO_Pin_14		        

#define RGB33_GPIO_CLK      RCC_APB2Periph_GPIOD
#define RGB33_GPIO_PORT     GPIOD		   
#define RGB33_GPIO_PIN		  GPIO_Pin_15
